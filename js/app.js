...
AFRAME.registerComponent('shootablewinner', {
    init: function () {
        this.el.addEventListener('click', () => {
            ...
            vid.setAttribute('height', '13');
            vid.setAttribute('position', '-3.5 7.5 30');
            ...
            vid2.setAttribute('height', '175');
            vid2.setAttribute('position', '-400 25 -100');
			vid2.setAttribute('rotation', '0 40 0');
